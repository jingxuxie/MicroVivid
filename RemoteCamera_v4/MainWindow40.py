...
#        self.save_file_button.setShortcut('Ctrl+S')
        ...
        color_temperature_lbl = QLabel('Color Temperature')
...
#        self.pixmap = QPixmap()
    ...
    def set_theme_light(self):
        ...
        self.pw_hist.setBackground('#FAFAFA')
...
#                                'is developing... ')
    ...
    def wheelEvent(self, event):
        ...
        pos_x = QWidget.mapFromGlobal(self, QCursor.pos()).x()
        pos_y = QWidget.mapFromGlobal(self, QCursor.pos()).y()
        ...
        if lim_x1 < pos_x < lim_x2 and lim_y1 < pos_y < lim_y2:
#        if not self.combo_mag.underMouse():    
            self.mouse_x1 = max(0, pos_x)
            self.mouse_y1 = max(0, pos_y)
...
#                print(self.frameGeometry().height() - self.geometry().height())
    ...
    def display_resize(self):
        ...
        self.scale_rate = min((self.window_width-340)/self.img_show_width, \
                              (self.window_height-130)/self.img_show_height)        
        ...
        self.lbl_main.setFixedHeight(self.window_height-130)
