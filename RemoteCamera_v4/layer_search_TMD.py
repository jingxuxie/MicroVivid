...
def layer_search_TMD(filename, thickness = '285nm'):
    img0 = cv2.imread(filename)
    img_raw = img0.copy()
    img_raw_for_draw = img0.copy()
    img = img0
    isLayer = False
